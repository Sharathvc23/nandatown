...
export const metadata = {
  title: "Hackathon Marketplace — NEST",
  description:
    "Browse every protocol and plugin submitted to the NEST hackathon, by layer, author, and judge score.",
};
        ...
        <div className="mx-auto max-w-[1240px] px-6 sm:px-10 pt-20 pb-16">
          ...
          <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr] lg:items-start">
            ...
            <p className="animate-fade-in stagger-2 text-[1.1rem] leading-[1.6] text-ink-500 lg:pt-6 max-w-md">
              Every plugin and protocol pitched at the NEST hackathon, with
